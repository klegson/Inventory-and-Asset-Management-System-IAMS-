...
<div class="top-header no-print">
    ...
    <div class="header-actions">
        ...
        <div class="user-profile" title="{{ $user->firstname ?? 'Staff' }} {{ $user->lastname ?? '' }}"><div class="user-avatar">{{ $initials }}</div></div>
    </div>
</div>
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    function fetchSearchResults(query) {
        ...
        const fetchUrl = `{{ url('/global-search') }}?q=${encodeURIComponent(query)}`;
