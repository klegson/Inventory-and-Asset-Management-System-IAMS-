...
INSERT INTO `assets` (`id`, `barcode_id`, `article`, `description`, `unit_measure`, `supplier`, `unit_value`, `quantity`, `status`) VALUES
	...
	(19, '2026-02-0019', 'Masking Tape', '', 'Pc', NULL, 40.00, 0, 'Serviceable');
...
-- Dumping data for table ams_inventory.migrations: ~9 rows (approximately)
...
-- Dumping data for table ams_inventory.ris_requests: ~0 rows (approximately)
INSERT INTO `ris_requests` (`id`, `user_id`, `ris_no`, `entity_name`, `division`, `office`, `fund_cluster`, `rcc`, `purpose`, `sig_requested_by`, `sig_approved_by`, `sig_issued_by`, `sig_received_by`, `desig_requested`, `desig_approved`, `desig_issued`, `desig_received`, `date_requested`, `date_approved`, `date_issued`, `date_received`, `status`, `created_at`) VALUES
	...
	(2, 3, 'RIS-2026-03-0002', 'Department of Education - ROV', 'General Services Unit', 'Administrative Division', NULL, NULL, NULL, 'czxczx', 'JEFFREY B. PAGATPAT', 'ALDRIN RELLAMA', 'ewqeqw', 'fdsafsad', 'Admin, Officer V (Supply Officer)', 'AA-VI (Storekeeper II)', 'fdsfsdfdfs', NULL, '2026-03-17', NULL, NULL, 'Approved', '2026-03-16 16:40:22'),
	(3, 3, 'RIS-2026-03-0003', 'Department of Education - ROV', 'Asset Management Section', 'Administrative Division', NULL, NULL, NULL, 'Karen', 'JEFFREY B. PAGATPAT', 'ALDRIN RELLAMA', 'Karen', 'Developer', 'Admin, Officer V (Supply Officer)', 'AA-VI (Storekeeper II)', 'Developer', NULL, NULL, NULL, NULL, 'Forwarded to Admin', '2026-03-17 17:26:44'),
...
INSERT INTO `sessions` (`id`, `user_id`, `ip_address`, `user_agent`, `payload`, `last_activity`) VALUES
	('EjeAz6avE9cehYxQ7rTlBKCIBTqBFKulTSEHr1aY', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/146.0.0.0 Safari/537.36', '', 1774856530),
	('HeT224DTKa93CyYFN6eIVqFLNELD4NoBfPXa1yKj', 1, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/146.0.0.0 Safari/537.36 Edg/146.0.0.0', '', 1774851168),
	('ht72mufDHEkTtV23ZOpZkysHJ07mqK7pN1WpAU5H', 1, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/146.0.0.0 Safari/537.36 Edg/146.0.0.0', '', 1774857005),
	('KYQghzIsxswgyUdNZzxJLVCNLv2zgivyHRSGPi8n', 1, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/146.0.0.0 Safari/537.36', '', 1774922172),
	('OzSuFD2ug9O3kclxIr1BjGZuD1FmypJ5O0vxZCgH', NULL, '192.168.127.2', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/146.0.0.0 Safari/537.36 Edg/146.0.0.0', '', 1774852888),
	('QhafYFXicJhu6MgRg9okxGqPSAXYpb1GdkD3dYxx', 4, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/146.0.0.0 Safari/537.36 Edg/146.0.0.0', '', 1774919886),
	('xfHQLIwG7ekIRWvXyoiNBJQ9PigpJWMSwZdjs4L2', 4, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/146.0.0.0 Safari/537.36', '', 1774859349);
...
INSERT INTO `supplies` (`id`, `barcode_id`, `article`, `description`, `supplier`, `unit_measure`, `unit_value`, `quantity`, `status`, `image`) VALUES
	(28, 'SUP-2026-03-0001', 'Alcohol', 'Ethyl, 500ml, 70% solution', NULL, 'Bottle', 63.00, 500, 'Available', NULL),
	(29, 'SUP-2026-03-0002', 'Alcohol', 'Ethyl, 1 Gallon , 70% solution', NULL, 'Gallon', 219.00, 20, 'Available', NULL),
	(31, 'SUP-2026-03-0004', 'Ballpen', 'ordinary, color blue, good quality', NULL, 'Piece', 6.10, 20000, 'Available', NULL),
	(32, 'SUP-2026-03-0005', 'Ballpen', 'ordinary , color blue, good quality', NULL, 'Piece', 6.10, 1200, 'Available', NULL),
	(33, 'SUP-2026-03-0006', 'Battery', 'dry cell, AA, 2 pieces/blister pack', NULL, 'Pack', 43.00, 460, 'Available', NULL),
	(34, 'SUP-2026-03-0007', 'Battery', 'dry cell, AAA, 2 pieces/blister pack', NULL, 'Pack', 52.00, 386, 'Available', NULL),
	(35, 'SUP-2026-03-0008', 'Binder Clip', '(black fold) 19mm, clamping depth 0.20mm, 12pcs/box', NULL, 'Box', 20.00, 170, 'Available', NULL),
	(36, 'SUP-2026-03-0009', 'Binder Clip', '(black fold) 25mm, clamping depth 0.20mm, 12 pcs/box', NULL, 'Box', 19.00, 261, 'Available', NULL),
	(37, 'SUP-2026-03-0010', 'Binder Clip', '(black fold) 32mm, clamping depth 0.20mm, 12 pcs/box', NULL, 'Box', 31.00, 217, 'Available', NULL),
	(38, 'SUP-2026-03-0011', 'Binder Clip', '(black fold ), 50mm, clamping depth 0.33mm, 12pcs/box', NULL, 'Box', 68.00, 200, 'Available', NULL),
	(39, 'SUP-2026-03-0012', 'Binder', 'Ring , plastic 32mm, black color, 10pcs/bundle', NULL, 'Bundle', 48.00, 49, 'Available', NULL),
	(40, 'SUP-2026-03-0013', 'Carbon Film', 'black,100sheets/pack, legal', NULL, 'Pack', 585.00, 20, 'Available', NULL),
	(41, 'SUP-2026-03-0014', 'Cartolina', 'assorted color, 78gsm, 572 x 724mm, 20pcs/pack', NULL, 'Pack', 155.00, 10, 'Available', NULL),
	(42, 'SUP-2026-03-0015', 'Certificate Holder', 'plastic, A4 size, 8.25" x 11.69', NULL, 'Piece', 41.00, 200, 'Available', NULL),
	(43, 'SUP-2026-03-0016', 'Certificate Holder', 'plastic, long, 8.5 x 13"', NULL, 'Piece', 43.00, 200, 'Available', NULL),
	(44, 'SUP-2026-03-0017', 'Certificate Holder', 'plastic, short, 8.5 x 11"', NULL, 'Piece', 39.00, 200, 'Available', NULL),
	(45, 'SUP-2026-03-0018', 'Clear book', '20 transparent  pockets , A4 size', NULL, 'Piece', 35.00, 200, 'Available', NULL),
	(46, 'SUP-2026-03-0019', 'Clear book', '20 transparent pockets, legal size', NULL, 'Piece', 40.00, 200, 'Available', NULL),
	(47, 'SUP-2026-03-0020', 'Clip Paper', 'big, vinyl, plastic coat, 50mm, 100pcs/box', NULL, 'Box', 20.00, 200, 'Available', NULL),
	(48, 'SUP-2026-03-0021', 'Colored Paper', 'short, 8.5 x 11, green, 250sheets/pack', NULL, 'Pack', 199.00, 20, 'Available', NULL),
	(49, 'SUP-2026-03-0022', 'Colored Paper', 'long, assorted, 250sheets/pack', NULL, 'Pack', 240.00, 20, 'Available', NULL),
	(50, 'SUP-2026-03-0023', 'Correction Tape', 'film base type UL 6m min', NULL, 'Piece', 23.00, 500, 'Available', NULL),
	(53, 'SUP-2026-03-0024', 'Data file Box', 'made of chipboard, with close ends', NULL, 'Piece', 121.00, 200, 'Available', NULL),
	(54, 'SUP-2026-03-0025', 'Data File Folder', '127x229mmx400mm, chipboard, blue', NULL, 'Piece', 89.00, 200, 'Available', NULL),
	(55, 'SUP-2026-03-0026', 'Envelope', 'mailing, long , 500pcs/ box', NULL, 'Box', 387.00, 20, 'Available', NULL),
	(56, 'SUP-2026-03-0027', 'Envelope', 'documentary, A4, 500pcs/box', NULL, 'Box', 1135.00, 21, 'Available', NULL),
	(57, 'SUP-2026-03-0028', 'T6641 INK Cartridge', 'black', NULL, 'Bottle', 310.00, 100, 'Available', NULL),
	(58, 'SUP-2026-03-0029', 'T6642 INK Cartridge', 'cyan', NULL, 'Bottle', 310.00, 40, 'Available', NULL),
	(59, 'SUP-2026-03-0030', 'T6643 INK Cartridge', 'magenta', NULL, 'Bottle', 40.00, 310, 'Available', NULL),
	(60, 'SUP-2026-03-0031', 'T6644 INK Cartridge', 'yellow', NULL, 'Bottle', 310.00, 40, 'Available', NULL),
	(61, 'SUP-2026-03-0032', 'Folder', 'Ordinary, white, long 100pcs per pack', NULL, 'Pack', 498.00, 50, 'Available', NULL),
	(62, 'SUP-2026-03-0033', '336XHigh Yield Black', 'original HP LaserJet', NULL, 'Bottle', 6910.00, 4, 'Available', NULL),
	(63, 'SUP-2026-03-0034', 'Printer Ink', 'GT 51/53 black, original', NULL, 'Bottle', 399.00, 50, 'Available', NULL),
	(64, 'SUP-2026-03-0035', 'Printer Ink', 'GT 52 cyan, original', NULL, 'Bottle', 399.00, 24, 'Available', NULL),
	(65, 'SUP-2026-03-0036', 'Printer Ink', 'GT 52 magenta, original', NULL, 'Bottle', 399.00, 24, 'Available', NULL),
	(66, 'SUP-2026-03-0037', 'Printer Ink', 'GT 52 yellow, original', NULL, 'Bottle', 399.00, 24, 'Available', NULL),
	(67, 'SUP-2026-03-0038', 'Index Tab', 'Alphabetical A-Z self-adhesive, transparent, 5sets/bx', NULL, 'Box', 90.00, 126, 'Available', NULL),
	(68, 'SUP-2026-03-0039', 'Computer Ink', 'No. 003 black original', NULL, 'Bottle', 310.00, 400, 'Available', NULL),
	(69, 'SUP-2026-03-0040', 'Computer Ink', 'No. 003 cyan, original', NULL, 'Bottle', 319.00, 200, 'Available', NULL),
	(70, 'SUP-2026-03-0041', 'Computer Ink', 'No. 003 yellow, original', NULL, 'Bottle', 319.00, 200, 'Available', NULL),
	(71, 'SUP-2026-03-0042', 'Insecticide', 'Aerosol type, 600 ml min.', NULL, 'Can', 498.00, 32, 'Available', NULL),
	(72, 'SUP-2026-03-0043', 'Interfolded Paper Towel', '175 pulls', NULL, 'Pack', 48.00, 200, 'Available', NULL),
	(73, 'SUP-2026-03-0044', 'Laid Paper', 'Long , Pink , 500 sheets per ream', NULL, 'Ream', 960.00, 20, 'Available', NULL),
	(74, 'SUP-2026-03-0045', 'Laid Paper', 'Long, Yellow, 500 sheets per ream', NULL, 'Ream', 960.00, 20, 'Available', NULL),
	(75, 'SUP-2026-03-0046', 'Laid Paper', 'Long , Light Blue, 500 sheets per ream', NULL, 'Ream', 960.00, 20, 'Available', NULL),
	(76, 'SUP-2026-03-0047', 'Laid Paper', 'Long, Light Green, 500 sheets per ream', NULL, 'Ream', 960.00, 20, 'Available', NULL),
	(77, 'SUP-2026-03-0048', 'Laid Paper', 'Long, Ivory, 500 sheets per ream', NULL, 'Ream', 960.00, 20, 'Available', NULL),
	(78, 'SUP-2026-03-0049', 'Laid Paper', 'Long Cream, 500 sheets per ream', NULL, 'Ream', 960.00, 20, 'Available', NULL),
	(79, 'SUP-2026-03-0050', 'Laid Paper', 'A4, Cream, 500 sheets per ream', NULL, 'Ream', 960.00, 20, 'Available', NULL),
	(80, 'SUP-2026-03-0051', 'Laid Paper', 'A4 Light Green, 500 sheets per ream', NULL, 'Ream', 960.00, 20, 'Available', NULL),
	(81, 'SUP-2026-03-0052', 'Laid Paper', 'A4, Pink , 500 sheets per ream', NULL, 'Ream', 960.00, 20, 'Available', NULL),
	(82, 'SUP-2026-03-0053', 'Laid Paper', 'A4, Yellow , 500 sheets per ream', NULL, 'Ream', 960.00, 20, 'Available', NULL),
	(83, 'SUP-2026-03-0054', 'Laid Paper', 'Short, Light Pink, 500 sheets per ream', NULL, 'Ream', 960.00, 20, 'Available', NULL),
	(84, 'SUP-2026-03-0055', 'Laid Paper', 'Short, Yellow, 500 sheets per ream', NULL, 'Ream', 960.00, 20, 'Available', NULL),
	(85, 'SUP-2026-03-0056', 'Marker', 'Fluorescent, Highlighter, 3 assorted colors per set, good quality', NULL, 'Ream', 105.00, 150, 'Available', NULL),
	(86, 'SUP-2026-03-0057', 'Notepad', 'stick on, 50mmx76mm min (2x3")', NULL, 'Pad', 22.00, 100, 'Available', NULL),
	(87, 'SUP-2026-03-0058', 'Notepad', 'stick on, 76mmx100, (3x4") min', NULL, 'Pad', 33.00, 100, 'Available', NULL),
	(88, 'SUP-2026-03-0059', 'Notepad', 'stick on, 76mmx76mm(3x3")', NULL, 'Pad', 25.00, 100, 'Available', NULL),
	(89, 'SUP-2026-03-0060', 'Notebook Spiral', '152 x 216mm, 60 leaves', NULL, 'Piece', 17.00, 300, 'Available', NULL),
	(90, 'SUP-2026-03-0061', 'Paper Cutter', 'Utility knife, heavy duty', NULL, 'Piece', 89.00, 50, 'Available', NULL),
	(91, 'SUP-2026-03-0062', 'Paper Parchment', '100 sheets/box, 210mmx297mm', NULL, 'Box', 12.00, 300, 'Available', NULL),
	(93, 'SUP-2026-03-0064', 'Pencil', 'lead,  with eraser, wood cased hardness, 12 pc/box, good quality', NULL, 'Piece', 12.00, 300, 'Available', NULL),
	(94, 'SUP-2026-03-0065', 'Pencil Sharpener', 'good quality, heavy duty', NULL, 'Piece', 329.00, 10, 'Available', NULL),
	(95, 'SUP-2026-03-0066', 'Photo Paper', 'long 100 pcs/pack', NULL, 'Pack', 210.00, 20, 'Available', NULL),
	(96, 'SUP-2026-03-0067', 'Push Pin', '0.25" diameter, plastic head, 100 pcs/box', NULL, 'Box', 35.00, 30, 'Available', NULL),
	(97, 'SUP-2026-03-0068', 'PVC  Plastic Cover', 'A4 transparent 200microns', NULL, 'Pack', 515.00, 20, 'Available', NULL),
	(98, 'SUP-2026-03-0069', 'PCV Plastic Cover', 'Long, transparent 200microns', NULL, 'Pack', 570.00, 20, 'Available', NULL),
	(99, 'SUP-2026-03-0070', 'PCV Plastic Cover', 'Short, transparent 200microns', NULL, 'Pack', 490.00, 20, 'Available', NULL),
	(100, 'SUP-2026-03-0071', 'Rags Cloth', 'all cotton, round, 32 pcs/bundle min.', NULL, 'Bundle', 92.00, 100, 'Available', NULL),
	(101, 'SUP-2026-03-0072', 'Record Book', '500 pages, 214mmx278mm min, 55gsm', NULL, 'Book', 225.00, 120, 'Available', NULL),
	(102, 'SUP-2026-03-0073', 'Record Book', '300 pages, 214mmx278mm min, 55gsm', NULL, 'Book', 196.00, 120, 'Available', NULL),
	(103, 'SUP-2026-03-0074', 'Rubber Band', '70mm min lay flat length (No. 18)', NULL, 'Box', 185.00, 32, 'Available', NULL),
	(104, 'SUP-2026-03-0075', 'Pair of Scissors', '5.5 inches minimum symmetrical/asymmetrical', NULL, 'Piece', 55.00, 50, 'Available', NULL),
	(105, 'SUP-2026-03-0076', 'Sign Pen', 'fine tip, black, .5mm, good quality', NULL, 'Piece', 21.00, 300, 'Available', NULL),
	(106, 'SUP-2026-03-0077', 'Sign Pen', 'fine tip, blue. 5mm, good quality', NULL, 'Piece', 21.00, 300, 'Available', NULL),
	(107, 'SUP-2026-03-0078', 'Sign Pen', 'medium tip, black .7mm, good quality', NULL, 'Piece', 21.00, 200, 'Available', NULL),
	(108, 'SUP-2026-03-0079', 'Sign Pen', 'medium tip, blue .7mm good quality', NULL, 'Piece(s)', 21.00, 200, 'Available', NULL),
	(109, 'SUP-2026-03-0080', 'Specialty Board', 'A4, 200 gsm pale cream 10 pcs/pack', NULL, 'Piece(s)', 43.00, 20, 'Available', NULL),
	(110, 'SUP-2026-03-0081', 'Stapler', 'standard type w/ staple wire remover, good quality', NULL, 'Piece(s)', 105.00, 50, 'Available', NULL),
	(111, 'SUP-2026-03-0082', 'Staple Wire', 'no. 35, good quality', NULL, 'Box', 35.00, 120, 'Available', NULL),
	(112, 'SUP-2026-03-0083', 'Stamp Pad Ink', 'violet, 50ml, good quality', NULL, 'Bottle', 75.00, 26, 'Available', NULL),
	(113, 'SUP-2026-03-0084', 'Tape', 'transparent, 1" thickness, 25 meters length', NULL, 'Roll', 14.00, 120, 'Available', NULL),
	(114, 'SUP-2026-03-0085', 'Tape', 'transparent, 2" thickness, 25 meters length', NULL, 'Roll', 38.00, 120, 'Available', NULL),
	(115, 'SUP-2026-03-0086', 'Tape', 'Masking, 1" thickness, 25 meters length', NULL, 'Roll', 19.00, 120, 'Available', NULL),
	(116, 'SUP-2026-03-0087', 'Tape', 'Masking, 2" thickness, 25 meters length', NULL, 'Roll', 41.00, 100, 'Available', NULL),
	(117, 'SUP-2026-03-0088', 'Tape', 'Packing, 2" thickness, 25 meters length', NULL, 'Roll', 43.00, 120, 'Available', NULL),
	(118, 'SUP-2026-03-0089', 'Teflon Tape', '3/4"', NULL, 'Roll', 45.00, 35, 'Available', NULL),
	(119, 'SUP-2026-03-0090', 'Tissue Paper', '2 ply', NULL, 'Roll', 13.80, 200, 'Available', NULL),
	(120, 'SUP-2026-03-0091', 'Trash Bag', 'XL, black, 10 pcs/ pack', NULL, 'Pack', 42.00, 50, 'Available', NULL),
	(121, 'SUP-2026-03-0092', 'Sign Pen', '(1.0) black, good quality', NULL, 'Piece(s)', 55.00, 300, 'Available', NULL),
	(122, 'SUP-2026-03-0093', 'Sign Pen', '(1.0) blue, good quality', NULL, 'Piece(s)', 55.00, 300, 'Available', NULL),
	(123, 'SUP-2026-03-0094', 'Light Bulb (LED)', '18 watts , good quality', NULL, 'Piece(s)', 95.00, 200, 'Available', NULL),
	(124, 'SUP-2026-03-0095', 'Faucet', 'good quality, brass, 1/2 hose bibb', NULL, 'Piece(s)', 288.00, 10, 'Available', NULL),
	(125, 'SUP-2026-03-0096', 'Flexible Hose', '1/2 x 1/2 x 18"', NULL, 'Piece(s)', 10.00, 67, 'Available', NULL),
	(126, 'SUP-2026-03-0097', 'Flat Cord', '(Electrical) No. 16, 130m per roll', NULL, 'Roll', 1490.00, 2, 'Available', NULL),
	(127, 'SUP-2026-03-0098', 'Outlet', '3 gang Surface Type  universal outlet', NULL, 'Piece(s)', 169.00, 17, 'Available', NULL),
	(128, 'SUP-2026-03-0099', 'Rubber Plug', 'Heavy Duty', NULL, 'Piece(s)', 98.00, 18, 'Available', NULL),
	(129, 'SUP-2026-03-0100', 'Aircon Outlet', 'Wide  universal outlet with ground', NULL, 'Piece(s)', 200.00, 11, 'Available', NULL),
	(130, 'SUP-2026-03-0101', 'Angle valve', '3 way 1/2x1/2 with dual switch', NULL, 'Piece(s)', 570.00, 10, 'Available', NULL),
	(131, 'SUP-2026-03-0102', 'Doorknob', 'HD, branded', NULL, 'Piece/s', 490.00, 20, 'Available', NULL),
	(132, 'SUP-2026-03-0103', 'Air freshener', 'aerosol 280 ml', NULL, 'Can', 280.00, 40, 'Available', NULL),
	(133, 'SUP-2026-03-0104', 'Fastener', 'metal, good quality, 50 sets per box', NULL, 'Box', 49.00, 100, 'Available', NULL),
	(134, 'SUP-2026-03-0105', 'Staple Wire Remover', 'plier type', NULL, 'Piece(s)', 61.00, 12, 'Available', NULL),
	(135, 'SUP-2026-03-0106', 'Hand Sanitizer', '60ml, good quality', NULL, 'Bottle', 45.00, 100, 'Available', NULL),
	(136, 'SUP-2026-03-0107', 'Steel  rack', '5 layers, good quality', NULL, 'Set', 3300.00, 3, 'Available', NULL),
	(137, 'SUP-2026-03-0108', 'Flash drive', '32 GB', NULL, 'Piece(s)', 315.00, 10, 'Available', NULL),
	(138, 'SUP-2026-03-0109', 'Glue', '240 grams, good quality', NULL, 'Bottle', 122.00, 50, 'Available', NULL),
	(139, 'SUP-2026-03-0110', 'Electrical Tape', '3 meters, 19x6mm, black PVC', NULL, 'Roll', 48.00, 20, 'Available', NULL),
	(140, 'SUP-2026-03-0111', 'Marker', 'Permanent, Black, good quality', NULL, 'Piece(s)', 15.00, 366, 'Available', NULL),
	(141, 'SUP-2026-03-0112', 'Marker', 'Permanent, Blue, good quality', NULL, 'Piece(s)', 15.00, 186, 'Available', NULL),
	(142, 'SUP-2026-03-0113', 'Marker', 'Permanent, Red, good quality', NULL, 'Piece(s)', 15.00, 29, 'Available', NULL),
	(143, 'SUP-2026-03-0114', 'Marker', 'Whiteboard, Black, good quality', NULL, 'Piece(s)', 28.00, 166, 'Available', NULL),
	(144, 'SUP-2026-03-0115', 'Marker', 'Whiteboard, Blue, good quality', NULL, 'Piece(s)', 28.00, 166, 'Available', NULL),
	(145, 'SUP-2026-03-0116', 'Marker', 'Whiteboard, Red, good quality', NULL, 'Piece(s)', 28.00, 66, 'Available', NULL),
	(146, 'SUP-2026-03-0117', 'Brother Ink', 'BT D60, black, original', NULL, 'Bottle', 485.00, 74, 'Available', NULL),
	(147, 'SUP-2026-03-0118', 'Brother Ink', 'BT5000C, original', NULL, 'Bottle', 510.00, 64, 'Available', NULL),
	(148, 'SUP-2026-03-0119', 'Brother Ink', 'BT 5000M, original', NULL, 'Bottle', 510.00, 56, 'Available', NULL),
	(149, 'SUP-2026-03-0120', 'Brother Ink', 'BT 5000Y, original', NULL, 'Bottle', 510.00, 56, 'Available', NULL),
	(150, 'SUP-2026-03-0121', 'File Organizer', 'expanding, plastic, 12 pockets', NULL, 'Piece(s)', 151.00, 48, 'Available', NULL),
	(151, 'SUP-2026-03-0122', 'Matrix Ribbon', 'Epson LX-310 Dot', NULL, 'Piece(s)', 229.00, 10, 'Available', NULL),
	(152, 'SUP-2026-03-0123', 'Catridge', 'HP 46, Black', NULL, 'Piece(s)', 890.00, 5, 'Available', NULL),
	(153, 'SUP-2026-03-0124', 'Catridge', 'HP 46, tricolor', NULL, 'Piece(s)', 890.00, 5, 'Available', NULL),
	(154, 'SUP-2026-03-0125', 'AMS Tesing', 'tesing testing', NULL, 'Piece(s)', 10.00, 48, 'Available', NULL);
...
-- Dumping data for table ams_inventory.users: ~3 rows (approximately)
INSERT INTO `users` (`id`, `firstname`, `lastname`, `employee_id`, `department`, `contact_number`, `email`, `username`, `password`, `role`, `status`, `created_at`) VALUES
	(1, 'Karen', 'Ocbian', NULL, 'Asset Management Section', NULL, 'admin@deped.gov.ph', 'admin', '$2y$12$kCuXC3YHhZ3kYyNoaTDqouuDwPDaI22AIX92m1VCve/aaovC9N3rS', 'admin', 'Active', '2026-02-12 15:09:20'),
	(3, 'Division', 'User', NULL, 'Personnel Section', NULL, 'user@deped.gov.ph', 'frontuser', '$2y$12$4XoR/gYAcHmf/96zVTQI5eoNOARXoapPYmvSnZ0a54q70N9dL1mTC', 'frontuser', 'Active', '2026-02-12 15:09:20'),
	(4, 'Jhoanna Marie', 'Rimpola', NULL, 'Asset Management Section', NULL, 'staff@deped.gov.ph', 'staff', '$2y$12$.f5Xurth74amozziJZI0RerBKH9TnAafVeK8mc6Q84I/gNlN/wTfS', 'staff', 'Active', '2026-02-12 15:18:56');
